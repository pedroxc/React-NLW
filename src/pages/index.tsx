...
export default function Home(props: HomeProps) {
  ...
  async function createPool(event: FormEvent) {
    ...
    try {
      ...
      setPoolTitle("");
      alert(
        "Bolão criado com sucesso, o código foi copiado para a área de trasnfêrencia"
      );
    } catch (err) {
      ...
      <main>
        ...
        <form onSubmit={createPool} className="mt-10 flex gap-2">
          <input
            ...
            className="flex-1 px-6 py-4 rounded bg-gray-800 border border-grat-600 text-sm text-gray-100"
          />
          <button
